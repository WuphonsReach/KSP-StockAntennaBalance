...
- Relay antennas will be made heavier and more expensive.
- More balancing of power usage.
...
- Communotron HG-55 -- Can reach back from parts of inner planet orbits with TS level 2
...
These antennas are also a lot more power-hungry then stock, so you won't want to use them on small science probes.

- HG-5 High Gain Antenna -- 2.5x as powerful as TS level 1, partial coverage of inner-planets when talking to TS2/RA-2 at Kerbin
